...
[![Build Silver-Ublue HWE][5]][6]
[![Build Silver-Ublue GTS][7]][8]
[![Build Silver-Ublue ISO][9]][10]
...
* [Latest][11] - `ghcr.io/dperson/silver-ublue:latest`
* [Latest nvidia open][13] - `ghcr.io/dperson/silver-ublue-nvidia-open:latest`
* [HWE][14] - `ghcr.io/dperson/silver-ublue-hwe:latest`
* [HWE nvidia open][16] - `ghcr.io/dperson/silver-ublue-hwe-nvidia-open:latest`

[comment]: # (* [Latest nvidia][12] - `ghcr.io/dperson/silver-ublue-nvidia:latest`)
[comment]: # (* [HWE nvidia][15] - `ghcr.io/dperson/silver-ublue-hwe-nvidia:latest`)

Based on Fedora 41, Gnome 47:
* [GTS][17] - `ghcr.io/dperson/silver-ublue:gts`
* [GTS nvidia open][19] - `ghcr.io/dperson/silver-ublue-nvidia-open:gts`

[comment]: # (* [GTS nvidia][18] - `ghcr.io/dperson/silver-ublue-nvidia:gts`)

## ISO

Installable ISO (built at least weekly) is available from:
* [latest iso][20]
* [latest iso sha256sum][21]
...
* Container tools CLI - distrobox / podman / docker compose
...
Images are signed with [cosign][22]. To verify the signature, run the following:
```bash
cosign verify \
...
# Install great kubernetes tools
...
This project is based on the [Universal Blue image template][23] and builds upon
...
[5]: https://github.com/dperson/silver-ublue/actions/workflows/build-image-latest-hwe.yml/badge.svg
[6]: https://github.com/dperson/silver-ublue/actions/workflows/build-image-latest-hwe.yml
[7]: https://github.com/dperson/silver-ublue/actions/workflows/build-image-gts.yml/badge.svg
[8]: https://github.com/dperson/silver-ublue/actions/workflows/build-image-gts.yml
[9]: https://github.com/dperson/silver-ublue/actions/workflows/build-iso-anaconda.yml/badge.svg
[10]: https://github.com/dperson/silver-ublue/actions/workflows/build-iso-anaconda.yml
[11]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue:latest
[12]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue-nvidia:latest
[13]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue-nvidia-open:latest
[14]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue-hwe:latest
[15]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue-hwe-nvidia:latest
[16]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue-hwe-nvidia-open:latest
[17]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue:gts
[18]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue-nvidia:gts
[19]: ostree-image-signed:docker://ghcr.io/dperson/silver-ublue-nvidia-open:gts
[20]: https://pub-3e297cc6eba24590a47d52faa734b43e.r2.dev/silver-ublue-latest-x86_64.iso
[21]: https://pub-3e297cc6eba24590a47d52faa734b43e.r2.dev/silver-ublue-latest-x86_64.iso-CHECKSUM
[22]: https://docs.sigstore.dev/cosign/overview
[23]: https://github.com/ublue-os/image-template