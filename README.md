...
Images are signed with [cosign][14]. To verify the signature, run the following:
```bash
cosign verify \
...
This project is based on the [Universal Blue image template][15] and builds upon
...
[12]: https://pub-3e297cc6eba24590a47d52faa734b43e.r2.dev/silver-ublue-latest-x86_64.iso
[13]: https://pub-3e297cc6eba24590a47d52faa734b43e.r2.dev/silver-ublue-latest-x86_64.iso-CHECKSUM
[14]: https://docs.sigstore.dev/cosign/overview
[15]: https://github.com/ublue-os/image-template