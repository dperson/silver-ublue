...
# gtk4-ding@smedius.gitlab.com rounded-window-corners@fxgn tasks-in-panel@fthx
# wiggle@mechtifs
for i in appindicatorsupport@rgcjonas.gmail.com \
      ...
      logomenu@aryan_k search-light@icedman.github.com \
      tailscale@joaophi.github.com tilingshell@ferrarodomenico.com; do
  ...
  #   (cd "$sysext/$i" && patch -p2 </ctx/build_files/base/0001*.patch)
  # fi
