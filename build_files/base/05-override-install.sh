...
# Patched shells and Switcheroo Patch (not used for F43+)
# Enable Terra repo
...
# Patch to enable pre-install-builds in flatpak
# dnf5 swap --repo=copr:copr.fedorainfracloud.org:ublue-os:staging \
#       --setopt=install_weak_deps=False -y flatpak flatpak
...
for i in appindicatorsupport@rgcjonas.gmail.com \
      ...
      rounded-window-corners@fxgn tailscale@joaophi.github.com \
