...
# Configure
. /etc/os-release
echo "Silver-Ublue release $VERSION_ID ($VERSION_CODENAME)" >/etc/system-release
...
echo -e "$ENROLLMENT_PASSWORD\n$ENROLLMENT_PASSWORD" |
      mokutil --import "$SECUREBOOT_KEY" || :
%end
EOF

sed -Ei 's/Fedora/Silver-Ublue/g; s/CentOS/Silver-Ublue/g' \
