...
url="https://docs.projectbluefin.io/installation#secure-boot"
WARNING_MSG="This machine has secure boot turned on, but you haven't enrolled"
WARNING_MSG+=" Universal Blue's keys. Failing to enroll these before rebooting"
WARNING_MSG+=" **may cause your system to fail to boot**. Follow"
WARNING_MSG+=" [the documentation]($url) for key enrollment information."
KEY_WARN_FILE="/run/user-motd-sbkey-warn.md"
KEY_DER_FILE="$(get_config '."der-path"' \
