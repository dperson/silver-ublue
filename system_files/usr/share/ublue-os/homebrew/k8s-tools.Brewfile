brew "dagger" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p dagger >/dev/null"
...
brew "k3sup" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p k3sup >/dev/null"
