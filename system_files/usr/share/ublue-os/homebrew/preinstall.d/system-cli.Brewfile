...
brew "rclone" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p rclone >/dev/null"
brew "restic" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p restic >/dev/null"
...
brew "smartmontools" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p smartmontools >/dev/null"
brew "squashfs" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p squashfs >/dev/null"
brew "stress-ng" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p stress-ng >/dev/null"
brew "tcpdump" unless system \
      "PATH=/bin:/usr/bin:/usr/local/bin type -p tcpdump >/dev/null"
